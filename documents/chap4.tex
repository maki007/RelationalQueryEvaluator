...
This example is taken from TPC benchmark\cite{benchmark}. $[DATE]$ and $[SEGMENT]$ are constants. Tables do not have any indices in this benchmark. Columns starting with o\_ are from table order, columns beginning with l\_ are from table lineitem and columns with prefix c\_ belongs table customers.
