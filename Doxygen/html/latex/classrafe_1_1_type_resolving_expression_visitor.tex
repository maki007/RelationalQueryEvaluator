...
Visitor make simple type analysis. It assumes that all types are correct and after the expression visit, there will be stored type of whole expression in variable result\+Type. 
