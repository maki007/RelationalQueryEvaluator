...
\item if the columns are not declared multiple times. If error is reported, then the compilation cannot continue. It also gives columns unique identifier, so other vistors do not have to work with string names. 
\end{DoxyItemize}
