...
Comparer for heap in greedy join order algorirthm. Compares plans bases on timecomplexity of plans\mbox{[}0\mbox{]}. Greedy join order algorirthm uses this structure with only one plan. 
