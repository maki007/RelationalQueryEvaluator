...
Base class for expression in expression tree. \hyperlink{class_expression}{Expression} trees are used in algebra nodes like selection, join, antijoin or column operations. 
